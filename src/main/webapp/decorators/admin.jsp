...
<link rel ="stylesheet" href ="<c:url value = '/template/admin/venobox/dist/venobox.min.css'/>" />
...
<body>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false"> <img
								...
								alt="user" class="profile-pic me-2">Admin Đẹp zai
						</a>
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
							href="<c:url value = '/admin/rooms'/>" aria-expanded="false">
	...
	<script type="text/javascript" src = "<c:url value = 'https://cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js'/>"></script>
	<script type="text/javascript" src = "<c:url value = 'https://cdn.datatables.net/1.12.1/js/dataTables.bootstrap4.min.js'/>"></script>
	<script>
	new VenoBox({
